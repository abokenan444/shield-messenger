...
const en: LandingT = {
  ...
  feat_messaging_desc: 'E2EE text, voice, and photo messages. Encrypted voice calls via Tor with hybrid encryption (X25519 + ML-KEM-1024).',
...
const nl: LandingT = {
  ...
  feat_messaging_desc: 'E2EE tekst-, spraak- en fotoberichten. Versleutelde spraakoproepen via Tor met hybride versleuteling (X25519 + ML-KEM-1024).',
