...
echo "Building Shield Messenger Core Library for Android..."
echo ""
...
mkdir -p ../shield-messenger-android/app/src/main/jniLibs/arm64-v8a
mkdir -p ../shield-messenger-android/app/src/main/jniLibs/armeabi-v7a

# Copy libraries
cp target/aarch64-linux-android/release/libshieldmessenger.so \
   ../shield-messenger-android/app/src/main/jniLibs/arm64-v8a/

cp target/armv7-linux-androideabi/release/libshieldmessenger.so \
   ../shield-messenger-android/app/src/main/jniLibs/armeabi-v7a/

echo ""
echo "Done! Libraries copied to:"
echo "  - shield-messenger-android/app/src/main/jniLibs/arm64-v8a/libshieldmessenger.so"
echo "  - shield-messenger-android/app/src/main/jniLibs/armeabi-v7a/libshieldmessenger.so"
echo ""
