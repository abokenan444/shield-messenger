...
extension Notification.Name {
    static let slInlineReply = Notification.Name("com.securelegion.inlineReply")
    static let slMarkRead = Notification.Name("com.securelegion.markRead")
    static let slAcceptCall = Notification.Name("com.securelegion.acceptCall")
    static let slDeclineCall = Notification.Name("com.securelegion.declineCall")
    static let slVerifyContact = Notification.Name("com.securelegion.verifyContact")
    static let slAcceptFriendRequest = Notification.Name("com.securelegion.acceptFriendRequest")
    static let slDeclineFriendRequest = Notification.Name("com.securelegion.declineFriendRequest")
    static let slNotificationTapped = Notification.Name("com.securelegion.notificationTapped")
}
