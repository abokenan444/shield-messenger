 ...
 */
@Database(
    entities = [Contact::class, Message::class, Wallet::class, ReceivedId::class, UsedSignature::class, Group::class, GroupMember::class, GroupMessage::class, CallHistory::class],
    version = 22,
    exportSchema = false
)
