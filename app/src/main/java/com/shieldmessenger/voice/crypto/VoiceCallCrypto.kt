package com.shieldmessenger.voice.crypto
...
class VoiceCallCrypto {
    ...
    companion object {
        ...
        const val HKDF_MASTER_CONTEXT = "ShieldMessenger-Voice-Call-Master-Key"
        const val HKDF_CIRCUIT_PREFIX = "ShieldMessenger-Voice-Circuit-"
    }
    ...
    fun deriveMasterKey(sharedSecret: ByteArray, callId: ByteArray): ByteArray {
        ...
        // Context: "ShieldMessenger-Voice-Call-Master-Key" + callId
    ...
    fun deriveCircuitKey(masterKey: ByteArray, circuitIndex: Int): ByteArray {
        ...
        // Context: "ShieldMessenger-Voice-Circuit-<index>"
