...
class LockActivity : AppCompatActivity() {
    ...
    private fun unlockApp() {
        ...
        com.shieldmessenger.utils.SessionManager.setUnlocked(this)
    ...
    private suspend fun sendPanicNotifications() {
        withContext(Dispatchers.IO) {
            try {
                ...
                val database = ShieldMessengerDatabase.getInstance(this@LockActivity, dbPassphrase)
                ...
                val messageService = com.shieldmessenger.services.MessageService(this@LockActivity)
    ...
    private suspend fun wipeAllData() {
        withContext(Dispatchers.IO) {
            try {
                ...
                withContext(Dispatchers.Main) {
                    try {
                        val torServiceIntent = Intent(this@LockActivity, com.shieldmessenger.services.TorService::class.java)
