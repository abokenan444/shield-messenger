 ...
 */
class ShieldMessengerApplication : Application() {

    companion object {
        private const val TAG = "ShieldMessengerApp"
    ...
    override fun onCreate() {
        ...
        // ShieldMessengerApplication instance in that process. We must skip ALL initialization
        ...
        try {
            ...
            CoroutineScope(Dispatchers.IO).launch {
                val ipfsManager = com.shieldmessenger.services.IPFSManager.getInstance(this@ShieldMessengerApplication)
