...
import com.shieldmessenger.database.dao.CallHistoryDao
import com.shieldmessenger.database.dao.CallQualityLogDao
import com.shieldmessenger.database.dao.ContactDao
import com.shieldmessenger.database.dao.ContactKeyChainDao
import com.shieldmessenger.database.dao.GroupDao
import com.shieldmessenger.database.dao.GroupPeerDao
import com.shieldmessenger.database.dao.CrdtOpLogDao
import com.shieldmessenger.database.dao.MessageDao
import com.shieldmessenger.database.dao.PendingFriendRequestDao
import com.shieldmessenger.database.dao.PendingGroupDeliveryDao
import com.shieldmessenger.database.dao.PendingPingDao
import com.shieldmessenger.database.dao.PingInboxDao
import com.shieldmessenger.database.dao.ReceivedIdDao
import com.shieldmessenger.database.dao.SkippedMessageKeyDao
import com.shieldmessenger.database.dao.UsedSignatureDao
import com.shieldmessenger.database.dao.WalletDao
...
import com.shieldmessenger.database.entities.PingInbox
 ...
 *
 * Database file location: /data/data/com.shieldmessenger/databases/shield_messenger.db
 */
@Database(
...
abstract class ShieldMessengerDatabase : RoomDatabase() {
    ...
    companion object {
        private const val TAG = "ShieldMessengerDatabase"
        private const val DATABASE_NAME = "shield_messenger.db"

        @Volatile
        private var INSTANCE: ShieldMessengerDatabase? = null
         ...
         */
        fun getInstance(context: Context, passphrase: ByteArray): ShieldMessengerDatabase {
         ...
         */
        private fun buildDatabase(context: Context, passphrase: ByteArray): ShieldMessengerDatabase {
            ...
            return try {
                Room.databaseBuilder(
                    ...
                    ShieldMessengerDatabase::class.java,
                    DATABASE_NAME
                )
                ...
                if (e.message?.contains("file is not a database") == true ||
                    ...
                    try {
                        ...
                        if (dbPath.exists()) {
                            com.shieldmessenger.utils.SecureWipe.secureDeleteFile(dbPath)
                        ...
                        if (dbJournal.exists()) {
                            com.shieldmessenger.utils.SecureWipe.secureDeleteFile(dbJournal)
                        }

                        val dbWal = context.getDatabasePath("$DATABASE_NAME-wal")
                        if (dbWal.exists()) {
                            com.shieldmessenger.utils.SecureWipe.secureDeleteFile(dbWal)
                        }

                        val dbShm = context.getDatabasePath("$DATABASE_NAME-shm")
                        if (dbShm.exists()) {
                            com.shieldmessenger.utils.SecureWipe.secureDeleteFile(dbShm)
                        }
                    } catch (e: Exception) {
