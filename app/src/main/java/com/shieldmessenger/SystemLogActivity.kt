...
class SystemLogActivity : BaseActivity() {
    ...
    private fun getPlainText(): String {
        ...
        return buildString {
            appendLine("ShieldMessenger System Log")
    ...
    private fun copyLogs() {
        ...
        clipboard.setPrimaryClip(ClipData.newPlainText("ShieldMessenger System Log", text))
    ...
    private fun shareLogs() {
        ...
        val intent = Intent(Intent.ACTION_SEND).apply {
            type = "text/plain"
            putExtra(Intent.EXTRA_SUBJECT, "ShieldMessenger System Log")
