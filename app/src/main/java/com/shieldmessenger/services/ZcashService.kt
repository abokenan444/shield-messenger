...
class ZcashService(private val context: Context) {
    ...
    companion object {
        ...
        private const val WALLET_ALIAS = "shieldmessenger_wallet"

        // Account key source identifier
        private const val ACCOUNT_KEY_SOURCE = "shieldmessenger"
        ...
        try {
            ...
            synchronizer = Synchronizer.newBlocking(
                ...
                setup = AccountCreateSetup(
                    accountName = "ShieldMessenger Wallet",
                    keySource = null,
    ...
    suspend fun setActiveZcashWallet(walletId: String): Result<String> = withContext(Dispatchers.IO) {
        try {
            ...
            val database = com.shieldmessenger.database.ShieldMessengerDatabase.getInstance(context, dbPassphrase)
    ...
    private suspend fun initializeSynchronizerForWallet(
        ...
        try {
            ...
            val walletAlias = "shieldmessenger_wallet_${walletId}"
            ...
            synchronizer = Synchronizer.newBlocking(
                ...
                walletInitMode = WalletInitMode.RestoreWallet,
                setup = AccountCreateSetup(
                    accountName = "ShieldMessenger Wallet $walletId",
                    keySource = null,
                    seed = FirstClassByteArray(seedBytes)
                ),
                isTorEnabled = true,
